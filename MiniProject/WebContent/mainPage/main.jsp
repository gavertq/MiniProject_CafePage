...
<p class="rp1"><button onclick="location.href='../event/summer_event.jsp'">바로 가기</button></p>
	...
	<section class="section_1">	
		<article class="article_flow" id="event1">
			...
			<span id="event_span" class="event_span1">
				<a id="event_a" class="event_a1" href="../event/reserve_event.jsp">자세히 보기</a>
			</span>
			</p>
		</article>
		...
		<article class="article_flow" id="event3">
			...
			<p id="event3_ment">
				...
				<span id="event_span" class="event_span3">
					<a id="event_a" class="event_a3" href="../event/newBlend.jsp?img=bean1.png">자세히 보기</a>
				</span>
			</p>
		</article>
